...
// First remove any existing unpackWebpackModules logic to avoid duplication
...
if (!newCode.includes('var unpackWebpackModules')) {
    newCode = newCode.replace('function main() {', newStep + '\nfunction main() {');
}

// Ensure it is called in main
if (!newCode.includes('unpackWebpackModules(cleanedCode)')) {
